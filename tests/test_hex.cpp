...
TEST(hex, custom) {
  ...
  EXPECT_EQ(hex_decode("00112233", 8, buf), 4);

  EXPECT_EQ(hex_decode("001122T3", 8, buf), 3);
  EXPECT_EQ(hex_decode("0011223T", 8, buf), 3);
}
