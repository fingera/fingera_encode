...
void _to_base64(const void *buf, size_t buf_size, char *out, int url_safe) {
...
static size_t _from_base64(const char *str, size_t str_len, void *buf,
                           int url_safe) {
...
size_t base64_encode_len(size_t buf_size) { return ((buf_size + 2) / 3) * 4; }
size_t base64_decode_max_len(size_t str_len) { return ((str_len + 3) / 4) * 3; }

void base64_encode(const void *buf, size_t buf_size, char *str) {
  _to_base64(buf, buf_size, str, 0);
}
...
size_t base64_decode(const char *str, size_t str_len, void *buf) {
  ...
  return _from_base64(str, str_len, buf, 0);
}
...
void base64url_encode(const void *buf, size_t buf_size, char *str) {
  _to_base64(buf, buf_size, str, 1);
}

size_t base64url_decode(const char *str, size_t str_len, void *buf) {
  return _from_base64(str, str_len, buf, 1);
}
